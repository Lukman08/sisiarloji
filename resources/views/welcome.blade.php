...
<head>
    ...
    <title>Sisi Arloji</title>
    <link rel="shortcut icon" href="{{ asset('slide/logo.png') }}" type="image/x-icon">
...
<body>
    ...
    <footer>
        <div class="container">
            <small>Copyright &copy; 2022 - Kelompok 4 D4RPL3. All Rights Reserved.</small>
        </div>
    </footer>
